...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='DCANet')
    ...
    parser.add_argument('--dataset',      type=str, default='Dataset-mask')
    ...
    parser.add_argument('--scheduler', default='CosineAnnealingLR',
                        choices=['CosineAnnealingLR', 'ReduceLROnPlateau', 'StepLR','MultiStepLR'])
