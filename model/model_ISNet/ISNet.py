...
from .my_functionals.GatedSpatialConv import  GatedSpatialConv2d
#from my_functionals.GatedSpatialConv import Conv2dPad
#from my_functionals.GatedSpatialConv import HighFrequencyGatedSpatialConv2d
from .network.Resnet import BasicBlock1
from .network.Resnet import BasicBlock
...
class ISNet(nn.Module):
    ...
    def forward(self, x):#, x_grad):
        ...
        #print('x_grad==',x_grad)
        m1f = F.interpolate(x, size=[hei, wid], mode='bilinear', align_corners=True)
